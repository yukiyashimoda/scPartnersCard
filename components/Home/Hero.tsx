...
function Hero() {
  ...
  <div className="relative flex flex-col">
    ...
    <button className='text-[12px] mx-2 mt-5 min-w-[80px] bg-transparent hover:bg-dark-brown text-gray-800 font-semibold hover:text-white py-2 px-4 border border-gray-800 hover:border-transparent rounded-full m-2 sm:m-2 hover:border-[1px] cursor-pointer duration-5 self-end'>
      お問合せはこちら
    </button>
  </div>
</div>
