    ...
    <div className='  w-full '>
      <div className="relative flex flex-col ">
        <div className="flex-grow">
          <h2 className='text-[14px] md:text-[12px] sm:-[10px] mt-5 ml-3 font-400 tracking-wide text-gray-600'>
            <span className='special-font'>SPECIAL CLUB</span>
          </h2>
          <h2 className='text-[40px] md:text-[35px] sm:-[30px] mt-[-15px] ml-3 font-600 justify-center'>
