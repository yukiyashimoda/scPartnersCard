...
function NavBar() {
  return (
    <div className='bg-transparent flex flex-col md:flex-row items-center justify-between p-3 px-5 z-99'>
      <div className='flex items-center gap-5 pl-[3%] p-1 justify-between'>   
        <div className='flex items-center gap-5 '>
          <Image src='/SClogo.svg' alt='logo' width={50} height={70} />
          <div>
            <h2 className='text-[14px] md:text-[12px] sm:-[10px] ml-3 font-400 tracking-widest text-emerald-600'>
