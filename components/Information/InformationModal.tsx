    ...
    <div className="modal-box w-95% max-w-2xl bg-white">
      <div className='grid grid-cols-1 p-[5px]'>
        <div className="">
          ...
          <div>
            <h2 className=' text-[14px] font-light pb-5 text-black'>{partner?.introduction}</h2>
          </div>
          ...
          <div className='flex h-100 mb-5 '>
            ...
            <div>
              <h2 className='text-[14px] font-light ml-1 text-gray-600'>{partner?.terms}</h2>
              <h2 className='text-[18px] font-bold pb-0 ml-1 text-emerald-600'>{partner?.benefit}</h2>
            </div>
          </div>
          <div>
            <h2 className='line-clamp-5 text-[12px] font-light text-gray-600'>{partner?.notice}</h2>
            </div>
          <div className='flex h-100 mt-4 mb-4 border-t border-b border-gray-300  '>
            ...
            <div>
              <h2 className='text-[14px] font-light ml-3 mt-5 text-black'>〒{partner?.postNumber}</h2>
