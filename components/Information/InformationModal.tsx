    ...
    <div className="modal-box w-95% max-w-2xl bg-white">
      <div className='grid grid-cols-1'>
        <div className="">
          <div className='flex'>
           <div>
           <button className="relative inline-flex items-center justify-center w-[52px] sm:w-[42px] h-[52px] sm:h-[42px] p-1 mb-1 me-2 overflow-hidden text-[10px] font-medium text-gray-900 rounded-lg group bg-emerald-600 focus:outline-none focus:ring-none">
          ...
          <div className='flex gap-2 pb-5'>
            <button type="button"
             className="flex flex-col items-center text-white bg-emerald-600 hover:bg-light-orange font-medium rounded-lg text-sm px-5 py-2.5 mb-2 flex-grow"
            ...
            <button type="button"
             className="flex flex-col items-center text-white bg-emerald-600 hover:bg-light-orange focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 mb-2 flex-grow"
